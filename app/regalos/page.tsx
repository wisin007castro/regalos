  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold text-pink-600 dark:text-pink-400 mb-2">Regalos Recibidos</h1>
        <p className="text-gray-500 dark:text-gray-400">Todos los regalos verificados para este cumpleanos especial</p>
      </div>

      {regalos.length === 0 ? (
        <div className="text-center py-16">
          <p className="text-5xl mb-4">🎁</p>
          <p className="text-gray-400 dark:text-gray-500 text-lg">Aun no hay regalos verificados</p>
