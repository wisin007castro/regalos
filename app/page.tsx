        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-gray-900 dark:border dark:border-purple-900/40 rounded-xl shadow-xl p-8">
            ...
            <ul className="space-y-3 text-gray-600 dark:text-gray-300">
              <li className="flex items-center gap-3"><span className="text-pink-500">1️⃣</span>Elige entre un abrazo virtual o una regalo</li>
              <li className="flex items-center gap-3"><span className="text-pink-500">2️⃣</span>Escribe tu mensaje de cumpleaños</li>
              <li className="flex items-center gap-3"><span className="text-pink-500">3️⃣</span>Si eliges un regalo, puedes enviar el regalo por QR</li>
              <li className="flex items-center gap-3"><span className="text-pink-500">4️⃣</span>Tu regalo aparecerá después de verificado</li>
            </ul>
          </div>
